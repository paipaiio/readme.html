...
5. 把内容重新组织成更适合阅读的 HTML 结构
6. 在 `README.md` 同目录生成 `README.html`
7. 给命令、配置、API 示例和重要参数增加一键复制按钮
8. 在存在参数设置的场景里增加简单的交互预览
9. 检查 HTML 是否保留了原始 README 的全部信息，并且体现关键项目结构
10. 只输出一个单文件 `README.html`，不额外生成模板 HTML、预览 HTML、CSS、JS 或资源文件
